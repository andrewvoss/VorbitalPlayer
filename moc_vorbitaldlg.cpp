...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VorbitalDlg_t, stringdata) + ofs \
...
const QMetaObject VorbitalDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_VorbitalDlg.data,
      qt_meta_data_VorbitalDlg,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VorbitalDlg.stringdata))
